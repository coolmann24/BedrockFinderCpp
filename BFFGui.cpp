...
wxBEGIN_EVENT_TABLE(BFFGui, wxFrame)
	EVT_BUTTON(1001, BFFGui::onAddClicked)
	EVT_BUTTON(1002, BFFGui::onRemoveClicked)
	EVT_BUTTON(1003, BFFGui::onShowClicked)
	EVT_BUTTON(1004, BFFGui::onResetClicked)
	EVT_BUTTON(1005, BFFGui::onSearch)
	EVT_COMMAND(1006, LOG_EVENT, BFFGui::log)
	EVT_COMMAND(1007, SEARCH_END_EVENT, BFFGui::endSearch)
	EVT_COMMAND(1008, LOG_PROGRESS_EVENT, BFFGui::logProgress)
wxEND_EVENT_TABLE()
